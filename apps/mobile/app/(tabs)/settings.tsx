...
const tcStyles = StyleSheet.create({
  ...
  scroll: { flex: 1 },
  heading: {
    fontFamily: 'PressStart2P_400Regular', fontSize: 16, color: gold,
    textAlign: 'center', marginBottom: 4,
  },
  tagline: {
    fontFamily: 'PressStart2P_400Regular', fontSize: 7, color: neonCyan,
  ...
  highlightTitle: {
    fontFamily: 'PressStart2P_400Regular', fontSize: 9, color: gold,
    marginBottom: 8,
  },
  highlightBody: {
  ...
  sectionTitle: {
    fontFamily: 'PressStart2P_400Regular', fontSize: 10, color: gold,
  ...
  closeBtn: {
    backgroundColor: 'rgba(255,215,0,0.15)', borderWidth: 1.5, borderColor: gold,
    borderRadius: 12, paddingVertical: 12, alignItems: 'center', marginTop: 10,
  },
  closeBtnText: {
    fontFamily: 'PressStart2P_400Regular', fontSize: 10, color: gold, letterSpacing: 1,
  },
});
