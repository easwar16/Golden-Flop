import type { TableStatePayload, TableInfo, HandResultPayload, PlayerAction } from './types';
...
export interface ClientToServerEvents {
     ...
     */
    sit_at_seat: (payload: SitAtSeatPayload, ack: (res: {
        seatIndex: number;
    } | {
        error: string;
    }) => void) => void;
    ...
    reserve_seat: (payload: ReserveSeatPayload, ack: (res: {
        ok: true;
    } | {
        error: string;
    }) => void) => void;
